      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex gap-3">
              {isAdmin && (
                <button
                  ...
                  className="px-4 py-2 bg-green-600 text-white rounded-md font-medium hover:bg-green-700 transition-colors flex items-center space-x-2"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-sm font-medium">Admin Access</p>
                <p className="text-2xl font-semibold text-gray-900 mt-1">
                  {isAdmin ? 'Yes' : 'No'}
                </p>
              </div>
              <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${isAdmin ? 'bg-red-100' : 'bg-gray-100'}`}>
                {isAdmin ? (
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <p className="text-gray-600 text-sm font-medium mb-1">Profile ID</p>
              <p className="text-gray-900 font-mono text-sm">{profile?.id || 'Not found'}</p>
            </div>
            <div>
              <p className="text-gray-600 text-sm font-medium mb-1">Username</p>
              <p className="text-gray-900 text-sm">{profile?.username || 'Not set'}</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-gray-600 text-sm font-medium mb-1">Profile Active</p>
              <p className="text-gray-900 text-sm">
                {profile?.is_active ? 'Active' : 'Inactive'}
              </p>
            </div>
