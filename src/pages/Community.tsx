...
const Community: React.FC = () => {
  const platforms = [
    {
      ...
      link: 'https://discord.gg/openforge',
  ...
  const events = [
    {
      title: 'OpenForge Developer Meetup',
      date: 'Monthly',
    ...
    },
    {
      ...
      date: 'Weekly',
      description: 'Showcase your projects built with OpenForge tools and get feedback from the community.',
      type: 'Showcase'
    }
  ];
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/60 max-w-2xl mx-auto">
              Join thousands of developers, creators, and innovators building the future with OpenForge.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              {
                title: 'Stay On Topic',
                description: 'Keep discussions relevant to OpenForge products, development, and related topics.'
              },
              {
