...
const FooterCTA: React.FC = () => {
  return (
    <section className="py-24 px-6 bg-gradient-to-br from-[#0A0A0A] via-[#111111] to-[#0A0A0A] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto">
            Experience the power of AI-driven workspace automation. Get started in minutes.
          </p>
