      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto">
            FiverFlow integrates seamlessly with the platforms you already use.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-8">
          {integrations.map((integration, index) => (
            ...
            >
              <div className="bg-white/5 border border-white/10 rounded-lg p-6 w-full aspect-square flex items-center justify-center hover:border-white/20 hover:bg-white/10 transition-all duration-300 group-hover:scale-105 group-hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]">
